package com.guuidea.inreading.service;
...
import com.guuidea.inreading.ui.base.BaseService;
import com.guuidea.inreading.utils.LogUtils;
import com.guuidea.inreading.utils.NetworkUtils;
...
public class DownloadService extends BaseService {
    ...
    private boolean checkAndAlterDownloadTask(DownloadTaskBean newTask) {
        ...
        for (DownloadTaskBean downloadTask : mDownloadTaskList) {
            ...
            if (!downloadTask.getBookId().equals(newTask.getBookId())) {
                continue;
            }
