...
class SystemBarUtils private constructor() {
    ...
    companion object {
        ...
        private val STABLE_NAV = View.SYSTEM_UI_FLAG_HIDE_NAVIGATION or
                ...
                View.SYSTEM_UI_FLAG_LAYOUT_STABLE or
                View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY;
        private val EXPAND_STATUS = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN or View.SYSTEM_UI_FLAG_LAYOUT_STABLE
        ...
        fun transparentNavBar(activity: Activity) {
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                //下面这个方法在sdk:21以上才有
                activity.window
                        .navigationBarColor = activity.getResources().getColor(android.R.color.transparent)
            }
        }
