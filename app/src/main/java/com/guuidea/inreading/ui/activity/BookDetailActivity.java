...
import com.guuidea.inreading.presenter.BookDetailPresenter;
...
import com.guuidea.inreading.ui.adapter.HotCommentAdapter;
...
public class BookDetailActivity extends BaseMVPActivity<BookDetailContract.Presenter>
    ...
    public void errorToBookShelf() {
        ...
        ToastUtils.Companion.show("加入书架失败，请检查网络");
    }
    ...
    public void succeedToBookShelf() {
        ...
        ToastUtils.Companion.show("加入书架成功");
    }
