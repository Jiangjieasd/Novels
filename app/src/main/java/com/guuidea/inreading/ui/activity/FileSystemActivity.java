...
import static com.guuidea.inreading.ui.fragment.BaseFileFragment.*;
...
import com.guuidea.inreading.ui.fragment.BaseFileFragment;
import com.guuidea.inreading.ui.fragment.FileCategoryFragment;
import com.guuidea.inreading.ui.fragment.LocalBookFragment;
    ...
    protected void initClick() {
        ...
        mBtnAddBook.setOnClickListener(
                (v) -> {
                    ...
                    changeCheckedAllStatus();
                    //提示加入书架成功
                    ToastUtils.Companion.show(getResources().getString(R.string.nb_file_add_succeed,collBooks.size()));
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton(getResources().getString(R.string.nb_common_sure), new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    //提示删除文件成功
                                    ToastUtils.Companion.show("删除文件成功");
                                }
                            })
